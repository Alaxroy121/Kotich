...
import com.kotich.app.core.LocalizedAppContext
...
import com.kotich.app.core.parser.CachingMangaRepository
import com.kotich.app.core.parser.MangaRepository
import com.kotich.app.core.prefs.AppSettings
import com.kotich.app.core.ui.image.TrimTransformation
import com.kotich.app.core.util.FileSize
import com.kotich.app.core.util.MimeTypes
import com.kotich.app.core.util.ext.URI_SCHEME_ZIP
import com.kotich.app.core.util.ext.cancelChildrenAndJoin
import com.kotich.app.core.util.ext.compressToPNG
import com.kotich.app.core.util.ext.ensureRamAtLeast
import com.kotich.app.core.util.ext.ensureSuccess
import com.kotich.app.core.util.ext.getCompletionResultOrNull
import com.kotich.app.core.util.ext.isFileUri
import com.kotich.app.core.util.ext.isNotEmpty
import com.kotich.app.core.util.ext.isPowerSaveMode
import com.kotich.app.core.util.ext.isZipUri
import com.kotich.app.core.util.ext.lifecycleScope
import com.kotich.app.core.util.ext.mangaSourceExtra
import com.kotich.app.core.util.ext.printStackTraceDebug
import com.kotich.app.core.util.ext.ramAvailable
import com.kotich.app.core.util.ext.toMimeType
import com.kotich.app.core.util.ext.use
import com.kotich.app.core.util.ext.withProgress
import com.kotich.app.core.util.progress.ProgressDeferred
import com.kotich.app.download.ui.worker.DownloadSlowdownDispatcher
...
class PageLoader @Inject constructor(
	...
	private var prefetchQueueLimit = PREFETCH_LIMIT_DEFAULT * 2 // Aggressive prefetch for fast connections
