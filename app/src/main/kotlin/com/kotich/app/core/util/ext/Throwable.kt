...
import com.kotich.app.core.exceptions.BadBackupFormatException
import com.kotich.app.core.exceptions.CaughtException
...
import com.kotich.app.core.exceptions.EmptyMangaException
import com.kotich.app.core.exceptions.IncompatiblePluginException
import com.kotich.app.core.exceptions.InteractiveActionRequiredException
import com.kotich.app.core.exceptions.NoDataReceivedException
import com.kotich.app.core.exceptions.NonFileUriException
import com.kotich.app.core.exceptions.ProxyConfigException
import com.kotich.app.core.exceptions.SyncApiException
import com.kotich.app.core.exceptions.UnsupportedFileException
import com.kotich.app.core.exceptions.UnsupportedSourceException
import com.kotich.app.core.exceptions.WrapperIOException
import com.kotich.app.core.exceptions.WrongPasswordException
...
import com.kotich.app.scrobbling.common.domain.ScrobblerAuthRequiredException
import java.io.File
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.kotich.app/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.kotich.app/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
