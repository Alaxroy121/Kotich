...
import com.kotich.app.alternatives.ui.AlternativesActivity
import com.kotich.app.backups.ui.backup.BackupDialogFragment
import com.kotich.app.backups.ui.restore.RestoreDialogFragment
import com.kotich.app.bookmarks.ui.AllBookmarksActivity
import com.kotich.app.browser.BrowserActivity
import com.kotich.app.browser.cloudflare.CloudFlareActivity
...
import com.kotich.app.core.model.appUrl
import com.kotich.app.core.model.getTitle
import com.kotich.app.core.model.isBroken
import com.kotich.app.core.model.isLocal
import com.kotich.app.core.model.parcelable.ParcelableManga
import com.kotich.app.core.model.parcelable.ParcelableMangaListFilter
import com.kotich.app.core.model.parcelable.ParcelableMangaPage
import com.kotich.app.core.network.CommonHeaders
import com.kotich.app.core.parser.external.ExternalMangaSource
import com.kotich.app.core.prefs.AppSettings
import com.kotich.app.core.prefs.ReaderMode
import com.kotich.app.core.prefs.TriStateOption
import com.kotich.app.core.ui.dialog.BigButtonsAlertDialog
import com.kotich.app.core.ui.dialog.ErrorDetailsDialog
import com.kotich.app.core.ui.dialog.buildAlertDialog
import com.kotich.app.core.util.ext.connectivityManager
import com.kotich.app.core.util.ext.findActivity
import com.kotich.app.core.util.ext.getThemeDrawable
import com.kotich.app.core.util.ext.printStackTraceDebug
import com.kotich.app.core.util.ext.toFileOrNull
import com.kotich.app.core.util.ext.toUriOrNull
import com.kotich.app.core.util.ext.withArgs
import com.kotich.app.details.ui.DetailsActivity
import com.kotich.app.details.ui.pager.ChaptersPagesSheet
import com.kotich.app.details.ui.related.RelatedMangaActivity
import com.kotich.app.details.ui.scrobbling.ScrobblingInfoSheet
import com.kotich.app.download.ui.dialog.DownloadDialogFragment
import com.kotich.app.download.ui.list.DownloadsActivity
import com.kotich.app.favourites.ui.FavouritesActivity
import com.kotich.app.favourites.ui.categories.FavouriteCategoriesActivity
import com.kotich.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.kotich.app.favourites.ui.categories.select.FavoriteDialog
import com.kotich.app.filter.ui.FilterCoordinator
import com.kotich.app.filter.ui.sheet.FilterSheetFragment
import com.kotich.app.filter.ui.tags.TagsCatalogSheet
import com.kotich.app.history.ui.HistoryActivity
import com.kotich.app.image.ui.ImageActivity
import com.kotich.app.list.ui.config.ListConfigBottomSheet
import com.kotich.app.list.ui.config.ListConfigSection
import com.kotich.app.local.ui.ImportDialogFragment
import com.kotich.app.local.ui.info.LocalInfoDialog
import com.kotich.app.main.ui.MainActivity
import com.kotich.app.main.ui.welcome.WelcomeSheet
...
import com.kotich.app.reader.ui.colorfilter.ColorFilterConfigActivity
import com.kotich.app.reader.ui.config.ReaderConfigSheet
import com.kotich.app.scrobbling.common.domain.model.ScrobblerService
import com.kotich.app.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.kotich.app.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.kotich.app.search.domain.SearchKind
import com.kotich.app.search.ui.MangaListActivity
import com.kotich.app.search.ui.multi.SearchActivity
import com.kotich.app.settings.SettingsActivity
import com.kotich.app.settings.about.AppUpdateActivity
import com.kotich.app.settings.override.OverrideConfigActivity
import com.kotich.app.settings.reader.ReaderTapGridConfigActivity
import com.kotich.app.settings.sources.auth.SourceAuthActivity
import com.kotich.app.settings.sources.catalog.SourcesCatalogActivity
import com.kotich.app.settings.storage.MangaDirectorySelectDialog
import com.kotich.app.settings.storage.directories.MangaDirectoriesActivity
import com.kotich.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.kotich.app.stats.ui.StatsActivity
import com.kotich.app.stats.ui.sheet.MangaStatsSheet
import com.kotich.app.suggestions.ui.SuggestionsActivity
import com.kotich.app.tracker.ui.updates.UpdatesActivity
import java.io.File
