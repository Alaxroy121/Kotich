package com.kotich.app.download.ui.worker
...
import com.kotich.app.core.image.BitmapDecoderCompat
import com.kotich.app.core.model.ids
...
import com.kotich.app.core.util.Throttler
import com.kotich.app.core.util.ext.MimeType
import com.kotich.app.core.util.ext.awaitFinishedWorkInfosByTag
import com.kotich.app.core.util.ext.awaitUpdateWork
import com.kotich.app.core.util.ext.awaitWorkInfosByTag
import com.kotich.app.core.util.ext.deleteAwait
import com.kotich.app.core.util.ext.deleteWork
import com.kotich.app.core.util.ext.deleteWorks
import com.kotich.app.core.util.ext.ensureSuccess
import com.kotich.app.core.util.ext.getDisplayMessage
import com.kotich.app.core.util.ext.getWorkInputData
import com.kotich.app.core.util.ext.getWorkSpec
import com.kotich.app.core.util.ext.openSource
import com.kotich.app.core.util.ext.printStackTraceDebug
import com.kotich.app.core.util.ext.toFileOrNull
import com.kotich.app.core.util.ext.toMimeType
import com.kotich.app.core.util.ext.toMimeTypeOrNull
import com.kotich.app.core.util.ext.withTicker
import com.kotich.app.core.util.ext.writeAllCancellable
import com.kotich.app.core.util.progress.RealtimeEtaEstimator
import com.kotich.app.download.domain.DownloadProgress
import com.kotich.app.download.domain.DownloadState
import com.kotich.app.local.data.LocalMangaRepository
import com.kotich.app.local.data.LocalStorageCache
import com.kotich.app.local.data.LocalStorageChanges
import com.kotich.app.local.data.PageCache
import com.kotich.app.local.data.TempFileFilter
import com.kotich.app.local.data.input.LocalMangaParser
import com.kotich.app.local.data.output.LocalMangaOutput
import com.kotich.app.local.domain.MangaLock
...
class DownloadWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val MAX_PAGES_PARALLELISM = 12
