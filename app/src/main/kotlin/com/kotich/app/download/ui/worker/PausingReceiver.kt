...
import com.kotich.app.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.kotich.app.download.PAUSE"
		private const val ACTION_RESUME = "com.kotich.app.download.RESUME"
		private const val ACTION_SKIP = "com.kotich.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.kotich.app.download.SKIP_ALL"
