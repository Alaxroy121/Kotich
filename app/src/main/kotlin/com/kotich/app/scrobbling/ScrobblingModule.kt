package com.kotich.app.scrobbling
...
import com.kotich.app.core.network.BaseHttpClient
import com.kotich.app.core.network.CurlLoggingInterceptor
import com.kotich.app.scrobbling.anilist.data.AniListAuthenticator
import com.kotich.app.scrobbling.anilist.data.AniListInterceptor
import com.kotich.app.scrobbling.anilist.domain.AniListScrobbler
import com.kotich.app.scrobbling.common.data.ScrobblerStorage
...
import com.kotich.app.scrobbling.common.domain.model.ScrobblerType
import com.kotich.app.scrobbling.kitsu.data.KitsuAuthenticator
import com.kotich.app.scrobbling.kitsu.data.KitsuInterceptor
import com.kotich.app.scrobbling.kitsu.data.KitsuRepository
import com.kotich.app.scrobbling.kitsu.domain.KitsuScrobbler
import com.kotich.app.scrobbling.mal.data.MALAuthenticator
import com.kotich.app.scrobbling.mal.data.MALInterceptor
import com.kotich.app.scrobbling.mal.domain.MALScrobbler
import com.kotich.app.scrobbling.shikimori.data.ShikimoriAuthenticator
import com.kotich.app.scrobbling.shikimori.data.ShikimoriInterceptor
import com.kotich.app.scrobbling.shikimori.domain.ShikimoriScrobbler
