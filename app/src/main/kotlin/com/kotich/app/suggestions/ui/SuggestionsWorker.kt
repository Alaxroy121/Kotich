package com.kotich.app.suggestions.ui
...
import com.kotich.app.core.exceptions.CloudFlareException
import com.kotich.app.core.exceptions.resolve.CaptchaHandler
import com.kotich.app.core.model.distinctById
import com.kotich.app.core.model.getLocale
import com.kotich.app.core.model.isNsfw
...
import com.kotich.app.core.util.LocaleComparator
import com.kotich.app.core.util.ext.asArrayList
import com.kotich.app.core.util.ext.awaitUniqueWorkInfoByName
import com.kotich.app.core.util.ext.awaitWorkInfosByTag
import com.kotich.app.core.util.ext.checkNotificationPermission
import com.kotich.app.core.util.ext.flatten
...
import com.kotich.app.core.util.ext.sanitize
import com.kotich.app.core.util.ext.takeMostFrequent
import com.kotich.app.core.util.ext.toBitmapOrNull
import com.kotich.app.core.util.ext.trySetForeground
...
import com.kotich.app.settings.work.PeriodicWorkScheduler
import com.kotich.app.suggestions.domain.MangaSuggestion
import com.kotich.app.suggestions.domain.SuggestionRepository
import com.kotich.app.suggestions.domain.TagsBlacklist
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.kotich.app.SUGGESTIONS"
